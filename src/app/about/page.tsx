    ...
    return (
        <div className={styles.pageWrapper}>
            <main className={styles.main}>
                    ...
                    <div className={styles.container}>
                        <div className={styles.whoGrid}>
                            ...
                            <div className={styles.whoCard}>
                                ...
                                <p className={styles.bodyMd} style={{ color: '#cbd5e1', fontSize: '1.05rem', lineHeight: '1.7', marginBottom: '1rem' }}>
                                ...
                                <p className={styles.bodyMd} style={{ color: '#cbd5e1', fontSize: '1.05rem', lineHeight: '1.7' }}>
                                    Our platform directly connects aspiring candidates with <strong style={{ color: '#fed488' }}>400+ star-category hotels</strong>, supported by signed MoUs with renowned hospitality chains nationwide to ensure financial self-reliance and global employment.
                                </p>
                            </div>
                            ...
                            <div className={styles.missionCard}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.25rem' }}>
                                    <div className={styles.iconWrapper} style={{ background: 'rgba(59, 130, 246, 0.2)', borderColor: 'rgba(59, 130, 246, 0.4)', color: '#60a5fa' }}>
                                        <svg className={styles.iconSvg} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <section className={styles.sectionPadding} style={{ background: '#000c1e' }}>
                    <div className={styles.container}>
                        <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
                            <span style={{ color: '#fed488', fontSize: '0.85rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em', background: 'rgba(254, 212, 136, 0.12)', padding: '0.35rem 0.9rem', borderRadius: '999px', border: '1px solid rgba(254, 212, 136, 0.3)', display: 'inline-block', marginBottom: '0.75rem' }}>
                                Key Advantages
                            </span>
                            <h2 className={styles.headlineLg} style={{ color: '#ffffff', marginBottom: '0.75rem' }}>
                                Why Choose SHARK?
                            </h2>
                            <p className={styles.bodyMd} style={{ color: '#93c5fd', maxWidth: '650px', margin: '0 auto', fontSize: '1.1rem' }}>
                        ...
                        <div className={styles.bentoGrid}>
                            ...
                            <div className={`${styles.bentoCard1} ${styles.bentoSpan2}`}>
                                ...
                                <h3 className={styles.headlineMd} style={{ color: '#ffffff', marginBottom: '0.5rem' }}>Free Enrollment for Students</h3>
                                <p className={styles.bodyMd} style={{ color: '#cbd5e1' }}>
                            ...
                            <div className={styles.bentoCard2}>
                                <div className={styles.iconWrapper} style={{ background: 'rgba(255,255,255,0.15)', borderColor: 'rgba(255,255,255,0.3)', color: '#ffffff', marginBottom: '1rem' }}>
                                    <svg className={styles.iconSvg} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className={styles.bentoCard3}>
                                ...
                                <h3 className={styles.headlineMd} style={{ color: '#fed488', marginBottom: '0.5rem' }}>Hassle-Free Portal</h3>
                                <p className={styles.bodyMd} style={{ color: '#cbd5e1' }}>
                            ...
                            <div className={`${styles.bentoCard4} ${styles.bentoSpan2}`}>
                                <div className={styles.iconWrapper} style={{ background: 'rgba(16, 185, 129, 0.15)', borderColor: 'rgba(16, 185, 129, 0.3)', color: '#34d399', width: '56px', height: '56px' }}>
                                ...
                                <div>
                                    <h3 className={styles.headlineMd} style={{ color: '#ffffff', marginBottom: '0.5rem' }}>Lifetime Placement Support</h3>
                                    <p className={styles.bodyMd} style={{ color: '#cbd5e1' }}>
                        ...
                        <div className={styles.lifetimeGrid}>
                            <div style={{ background: 'rgba(255, 255, 255, 0.04)', backdropFilter: 'blur(16px)', padding: '2rem', borderRadius: '1.5rem', border: '1px solid rgba(255, 255, 255, 0.12)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
                                ...
                                <p style={{ fontSize: '0.95rem', color: '#cbd5e1', lineHeight: 1.6 }}>
                                    Dedicated exclusively to hotel management talent at <strong style={{ color: '#fed488' }}>sharkedutech.com</strong>.
                                </p>
                            </div>

                            <div style={{ background: 'rgba(255, 255, 255, 0.04)', backdropFilter: 'blur(16px)', padding: '2rem', borderRadius: '1.5rem', border: '1px solid rgba(255, 255, 255, 0.12)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
                                <div style={{ fontSize: '1.8rem', marginBottom: '0.75rem' }}>🔔</div>
                                <h3 style={{ fontSize: '1.2rem', fontWeight: 700, color: '#ffffff', marginBottom: '0.5rem' }}>Exclusive Job Alerts</h3>
                                <p style={{ fontSize: '0.95rem', color: '#cbd5e1', lineHeight: 1.6 }}>
                            ...
                            <div style={{ background: 'rgba(255, 255, 255, 0.04)', backdropFilter: 'blur(16px)', padding: '2rem', borderRadius: '1.5rem', border: '1px solid rgba(255, 255, 255, 0.12)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
                                <div style={{ fontSize: '1.8rem', marginBottom: '0.75rem' }}>🎓</div>
                                <h3 style={{ fontSize: '1.2rem', fontWeight: 700, color: '#ffffff', marginBottom: '0.5rem' }}>Skill Upgrade Programs</h3>
                                <p style={{ fontSize: '0.95rem', color: '#cbd5e1', lineHeight: 1.6 }}>
                            ...
                            <div style={{ background: 'rgba(255, 255, 255, 0.04)', backdropFilter: 'blur(16px)', padding: '2rem', borderRadius: '1.5rem', border: '1px solid rgba(255, 255, 255, 0.12)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
                                <div style={{ fontSize: '1.8rem', marginBottom: '0.75rem' }}>👥</div>
                                <h3 style={{ fontSize: '1.2rem', fontWeight: 700, color: '#ffffff', marginBottom: '0.5rem' }}>Alumni Network</h3>
                                <p style={{ fontSize: '0.95rem', color: '#cbd5e1', lineHeight: 1.6 }}>
                            ...
                            <div style={{ background: 'rgba(255, 255, 255, 0.04)', backdropFilter: 'blur(16px)', padding: '2rem', borderRadius: '1.5rem', border: '1px solid rgba(255, 255, 255, 0.12)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
                                <div style={{ fontSize: '1.8rem', marginBottom: '0.75rem' }}>🧭</div>
                                <h3 style={{ fontSize: '1.2rem', fontWeight: 700, color: '#ffffff', marginBottom: '0.5rem' }}>Guidance &amp; Mentorship</h3>
                                <p style={{ fontSize: '0.95rem', color: '#cbd5e1', lineHeight: 1.6 }}>
                            ...
                            <div style={{ background: 'rgba(255, 255, 255, 0.04)', backdropFilter: 'blur(16px)', padding: '2rem', borderRadius: '1.5rem', border: '1px solid rgba(255, 255, 255, 0.12)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
                                <div style={{ fontSize: '1.8rem', marginBottom: '0.75rem' }}>🏥</div>
                                <h3 style={{ fontSize: '1.2rem', fontWeight: 700, color: '#ffffff', marginBottom: '0.5rem' }}>0% Interest Loan &amp; Insurance</h3>
                                <p style={{ fontSize: '0.95rem', color: '#cbd5e1', lineHeight: 1.6 }}>
                        ...
                        <div className={styles.deptGrid}>
                            ...
                            <div style={{ background: 'rgba(255, 255, 255, 0.04)', backdropFilter: 'blur(16px)', padding: '2.25rem', borderRadius: '1.5rem', border: '1px solid rgba(255, 255, 255, 0.12)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                                    ...
                                    <h3 style={{ fontSize: '1.3rem', fontWeight: 800, color: '#ffffff', margin: 0 }}>Food &amp; Beverage Service</h3>
                                </div>
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem' }}>
                                    {['F&B Manager', 'Restaurant Manager', 'Bar Manager', 'Nightclub Manager', 'Banquet Manager', 'Catering Manager', 'Venue Coordinator', 'Maitre D\'Hotel'].map((role, i) => (
                                        <span key={i} style={{ padding: '0.3rem 0.75rem', background: 'rgba(37, 99, 235, 0.2)', border: '1px solid rgba(59, 130, 246, 0.3)', color: '#93c5fd', borderRadius: '8px', fontSize: '0.8rem', fontWeight: 600 }}>
                                            {role}
                                        </span>
                                    ))}
                                </div>
                            ...
                            <div style={{ background: 'rgba(255, 255, 255, 0.04)', backdropFilter: 'blur(16px)', padding: '2.25rem', borderRadius: '1.5rem', border: '1px solid rgba(255, 255, 255, 0.12)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                                    <span style={{ fontSize: '1.6rem' }}>👨‍🍳</span>
                                    <h3 style={{ fontSize: '1.3rem', fontWeight: 800, color: '#ffffff', margin: 0 }}>Food &amp; Beverage Production</h3>
                                </div>
                                <p style={{ fontSize: '0.95rem', color: '#cbd5e1', marginBottom: '1.25rem' }}>
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem' }}>
                                    {['Commis Chef', 'Chef de Partie (CDP)', 'Sous Chef', 'Executive Chef', 'Corporate Chef', 'Production Manager (Kitchen)'].map((role, i) => (
                                        <span key={i} style={{ padding: '0.3rem 0.75rem', background: 'rgba(254, 212, 136, 0.15)', border: '1px solid rgba(254, 212, 136, 0.3)', color: '#fed488', borderRadius: '8px', fontSize: '0.8rem', fontWeight: 600 }}>
                                            {role}
                                        </span>
                                    ))}
                                </div>
                            ...
                            <div style={{ background: 'rgba(255, 255, 255, 0.04)', backdropFilter: 'blur(16px)', padding: '2.25rem', borderRadius: '1.5rem', border: '1px solid rgba(255, 255, 255, 0.12)', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem' }}>
                                    {['Room Attendant', 'Housekeeping Supervisor', 'Floor Supervisor', 'Executive Housekeeper', 'Rooms Division Manager', 'Director of Operations'].map((role, i) => (
                                        <span key={i} style={{ padding: '0.3rem 0.75rem', background: 'rgba(16, 185, 129, 0.15)', border: '1px solid rgba(16, 185, 129, 0.3)', color: '#34d399', borderRadius: '8px', fontSize: '0.8rem', fontWeight: 600 }}>
                                            {role}
                                        </span>
                                    ))}
                                </div>
                    ...
                    <div className={styles.container}>
                        <div className={styles.whoGrid}>
                            ...
                            <div className={styles.directorCard}>
                                <span style={{ color: '#fed488', fontSize: '0.8rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em', background: 'rgba(254, 212, 136, 0.12)', border: '1px solid rgba(254, 212, 136, 0.3)', padding: '0.35rem 0.85rem', borderRadius: '999px', display: 'inline-block', marginBottom: '1.25rem' }}>
                                    Leadership Vision
                                </span>
                                <h2 className={styles.headlineLg} style={{ color: '#ffffff', marginBottom: '1.25rem' }}>
                                ...
                                <p className={styles.headlineMd} style={{ color: '#ffffff', marginBottom: '0.25rem' }}>Mr. Maminul Akanda</p>
                                <p style={{ fontSize: '0.85rem', fontWeight: 700, color: '#93c5fd', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Managing Director &amp; CEO, Shark Edutech</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className={styles.sectionPadding} style={{ background: 'linear-gradient(180deg, #000c1e 0%, #001736 100%)', borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
                    <div className={styles.container}>
                        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
                            <h2 className={styles.headlineLg} style={{ color: '#ffffff', marginBottom: '0.5rem' }}>Corporate Office</h2>
                        ...
                        <div className={styles.corpBox}>
                            <div className={styles.corpGrid}>
                                ...
                                <div>
                                    <h4 style={{ fontSize: '0.85rem', fontWeight: 800, color: '#fed488', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.5rem' }}>Official Website</h4>
                                    <a href="https://www.sharkedutech.com" target="_blank" rel="noreferrer" style={{ fontWeight: 700, color: '#60a5fa', fontSize: '1.05rem', textDecoration: 'none' }}>
                                        www.sharkedutech.com
                                    </a>
                                </div>

                                <div>
                                    <h4 style={{ fontSize: '0.85rem', fontWeight: 800, color: '#fed488', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.5rem' }}>Contact Email &amp; Phone</h4>
                                    <p style={{ fontWeight: 600, color: '#cbd5e1', margin: '0 0 0.25rem 0' }}>✉️ info@sharkedutech.com</p>
                                    <p style={{ fontWeight: 600, color: '#cbd5e1', margin: 0 }}>📞 +91 91473 31167</p>
                                </div>

                                <div>
                                    <h4 style={{ fontSize: '0.85rem', fontWeight: 800, color: '#fed488', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '0.5rem' }}>Corporate Address</h4>
                                    <p style={{ fontWeight: 600, color: '#cbd5e1', fontSize: '0.95rem', margin: 0, lineHeight: 1.5 }}>
